...
export const admitCardsData = [
  ...
  
  {
    ...
    links: {
      ...
      examDate: "https://upsssc.gov.in/ViewPdf.aspx?uj/PsGPN75JGwQo7tR370HnmrZzaM6wNZZKlUFfosrI=", // will show "Link Activate Soon"
  ...
  totalPosts: "3717",
    ...
    vacancy: [
      ...
      { postName: "Total", category: "-", total: "3717",
         eligibility: "Refer official notification for complete details." }
    ],
    ...
    links: {
      ...
      examDate: "https://www.mha.gov.in/en/notifications/vacancies", // will show "Link Activate Soon"
  ...
  // Chandigarh JBT Teacher Admit Card 2025

  {
    ...
    vacancy: [
      ...
      { postName: "Total", category: "-", total: "218",
        eligibility: "2 Year Diploma in Elementary Education (D.El.Ed.) Recognized by NCTE with CTET qualification. For more details, read the official notification." }
    ],
    ...
    //  MPESB Excise Constable Admit Card 2025

    {
      ...
      vacancy: [
        { postName: "Excise Constable", category: "Total", total: "253",
          eligibility: "12th Exam Passed OR Equivalent from any recognized board in India. Minimum Age: 18 Years, Maximum Age: 33 Years (as on 01.01.2024) with relaxations as per MP Govt. norms." }
      ],
    ...
    //BPSC 71st CCE Prelims Admit Card 2025
    ...
    //SBI Probationary Officer Salary 2025
    {
      id: "SBI-PO-2025",
...

    {
      ...
      examDate: "20, 21 & 27 September 2025 (Prelims); 15 & 16 November 2025 (Mains, tentative)",
      totalPosts: "6,589",
    ...
    //PFRDA Assistant Manager (Grade A) Exam 2025
    {
    ...
    // Indian Navy Civilian Entrance Test (INCET) 2025
    {
    ...
    //BPSSC Enforcement Sub Inspector Exam 2025
    {
    ...
    //WBSSC Assistant Teacher Exam 2025 (2nd SLST)
    {
      ...
      "examDate": "07 September 2025 (Classes IX–X); 14 September 2025 (Classes XI–XII)",
      "totalPosts": "35,726",
      ...
      "instructions": [
        ...
        "Arrive well before the reporting time to complete entry formalities."
      ],
      "examGuidelines": [
        "Follow the exam session and center as printed on your admit card; no changes allowed.",
        "Electronic devices like phones, calculators, and wristwatches are strictly prohibited.",
    ...
    //IBPS PO Exam 2025
    {
      ...
      "examDate": "17, 23 & 24 August 2025 (Prelims); 12 October 2025 (Mains)",
      "totalPosts": "5,208",
