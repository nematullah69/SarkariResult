...
const HomePage = () => {
  ...
  const latestNotifications = [
    { id: "ssc-cgl-2025", title: "SSC CGL 2025 Notification", organization: "SSC", date: "18 Jun 2024" },
    { id: "upsc-cse-2025", title: "UPSC CSE 2025 Notification", organization: "UPSC", date: "14 Feb 2024" },
    { id: "railway-ntpc-2024", title: "Railway NTPC 2024 Notification", organization: "RRB", date: "15 Jul 2024" },
    { id: "gate-2025", title: "GATE 2025 Notification", organization: "IIT", date: "30 Aug 2024" },
  ];
  ...
  return (
    <div className="bg-white rounded-lg shadow p-4 w-full sm:w-[47%] lg:w-[30%]">
      <div className="flex items-center justify-between mb-3">
        ...
        <Link to={link} className="text-blue-600 hover:text-blue-800 text-xs font-medium flex items-center">
