...
const SyllabusDetailsPage = () => {
  ...
  // Find related exams (same category, same organization, or same exam type)
  const relatedExams = syllabusData
    .filter(s => s.id !== id && (
      s.category === syllabus.category || 
      s.organization === syllabus.organization || 
      s.examType === syllabus.examType
    ))
    .slice(0, 3); // Limit to 3 related exams
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h1 className="text-2xl font-bold text-gray-800 mb-2">{syllabus.examName}</h1>
