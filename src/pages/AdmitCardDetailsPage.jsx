...
const AdmitCardDetailsPage = () => {
  ...
  // If admitCard not found, render "Not Found" page
  if (!admitCard) {
    return (
    ...
    <tbody>
      <tr className="border-b">
        ...
        <td className="p-3 text-blue-600 font-medium">
          <a href={admitCard.links?.admitCard || "#"} target="_blank" rel="noopener noreferrer">
            Click Here
          </a>
        </td>
      </tr>
      <tr className="border-b">
        ...
        <td className="p-3 text-red-600 font-medium">
          {admitCard.links?.examDate ? (
            <a href={admitCard.links.examDate} target="_blank" rel="noopener noreferrer">
              Click Here
            </a>
          ) : (
            "Link Activate Soon"
      ...
      <tr className="border-b">
        ...
        <td className="p-3 text-blue-600 font-medium">
          <a href={admitCard.links?.notification || "#"} target="_blank" rel="noopener noreferrer">
            Click Here
          </a>
        </td>
      </tr>
      <tr className="border-b">
        ...
        <td className="p-3 text-blue-600 font-medium">
          <a href={admitCard.links?.officialWebsite || "#"} target="_blank" rel="noopener noreferrer">
            Click Here
          </a>
        </td>
      </tr>
      {/* <tr>
        <td className="p-3 font-semibold text-gray-800">Homepage</td>
        <td className="p-3 text-blue-600 font-medium">
          <a href={admitCard.links?.homepage || "#"} target="_blank" rel="noopener noreferrer">
            Click Here
          </a>
        </td>
      </tr> */}
        ...
        <div className="space-y-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <ul className="space-y-2 text-gray-700">
              ...
              <li>
                <strong>Category:</strong> {admitCard.category}
              </li>
            </ul>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-blue-700 text-sm">
              Please carry a valid photo ID proof along with your admit card to
              the exam center.
            </p>
          </div>
        </div>
