...
import { Target, Users, Award, Shield, CheckCircle, Globe } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'All data is encrypted and secured with industry-standard security protocols.'
    },
    {
      icon: CheckCircle,
      title: 'Verified Information',
      description: 'All results and information are verified directly from official sources.'
    },
    {
      icon: Globe,
      title: 'Nationwide Coverage',
      description: 'Comprehensive coverage of government examinations across India.'
    },
    {
      icon: Users,
      title: 'User-Friendly',
      description: 'Simple and intuitive interface designed for all users.'
    }
  ];
